...
$typecarte= isset($_POST["type_carte_paiement"])? $_POST["type_carte_paiement"] : "";
...
if ($db_found) {
    ...
    $sql = "INSERT INTO acheteur(email_acheteur,adresse_1,adresse_2,ville,code_postal,pays,num_tel,type_carte_paiement,num_carte,nom_carte,date_expiration,code_securite)
